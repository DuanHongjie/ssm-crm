...
(function ($) {
    ...
    $.messager = {
        show: function (_263) {
            ...
            var _26b = "<div class=\"messager-icon messager-question\"></div>" + "<div>" + msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>" + "<div> <select class=\"messager-input\"><option value=\"公司人员流动导致客户流失\" >公司人员流动导致客户流失</option><option value=\"竞争对手夺走客户\" selected>竞争对手夺走客户</option><option value=\"市场波动导致失去客户\" >市场波动导致失去客户</option><option value=\"细节的疏忽使客户离去\" >细节的疏忽使客户离去</option><option value=\"诚信问题让客户失去\" >诚信问题让客户失去</option><option value=\"店大欺客，客户不堪承受压力\" >店大欺客，客户不堪承受压力</option><option value=\"企业管理不平衡，令中小客户离去\" >企业管理不平衡，令中小客户离去</option><option value=\"自然流失\" >自然流失</option></select> </div>";
            var _26c = {};
